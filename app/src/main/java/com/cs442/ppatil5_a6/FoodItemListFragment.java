...
public class FoodItemListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //FoodItemAdapter foodAdapter = new FoodItemAdapter(getActivity(), FoodItemContent.ITEMS);
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(Integer.toString(FoodItemContent.ITEMS.get(position).getId()));
    }
    ...
    private void changeBackgroundColorSelection(View selectedView){
        if (currentSelectedView != null && currentSelectedView != selectedView) {
            currentSelectedView.setBackground(getResources().getDrawable(R.drawable.row_bg));
        }
